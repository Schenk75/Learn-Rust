...
fn parse_log(line: String) -> (Event, Message) { // <4> A function for parsing a line and converting it into semi-structured data
...
fn main() {
    let f = std::fs::File::open("test.log").unwrap();
